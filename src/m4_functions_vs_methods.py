...
def try_methods_and_functions():
    ...
    ricky.pen = rg.Pen('blue', 5)
    ricky.backward(150)
    ricky.speed = 1
    draw_many_squares(ricky, 2, 100, 30)

    ricky.speed = 5
    ricky.pen.color = 'red'
    draw_many_squares(ricky, 10, 50, 15)

    ricky.speed = 100
    ricky.pen.thickness = 35
    draw_many_squares(ricky, 8, 300, 60)

    ricky.pen = rg.Pen('black', 3)

    ricky.backward(200)

    ricky.draw_circle(30)

    ricky.draw_square(50)
    ###########################################################################
