...
def main():
    ...
    even_better_draw_circles(rg.Point(100, 20), 10, 20, 'red', 5)
    even_better_draw_circles(rg.Point(0, 20), 10, 20, 'green', 5)
    even_better_draw_circles(rg.Point(-100, 20), 10, 20, 'blue', 5)
...
#
#
# NOTE THAT THE CIRCLES ARE NOT PERFECTLY SYMMETRICAL... WHY?
#
# #############################################################################
...
def even_better_draw_circles(point, radii, number, colour, thickness):
